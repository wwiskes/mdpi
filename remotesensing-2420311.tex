...
\pubyear{2023}
\copyrightyear{2023}
\externaleditor{Academic Editor: {Yanjun Su} %MDPI: Please add this part.
}
...
\Title{Identification of Abandoned Logging Roads in Point Reyes \highlighting{National Seashore}}
%MDPI: IMPORTANT INFORMATION: 
%1. Please ensure that this is the final version that can be published and confirm that you will require no further changes from hereon.
%2. Please proof on this version as we have already done the English editing and formatting changes. Please do the proofreading with track changes. Do reply all comments and do not delete them. Thank you
...
\Author{\hl{William T. Wiskes} *\orcidA{}, %MDPI: 1. Please carefully check the accuracy of ALL names and affiliations.
%2. The name of this author is different from the one submitted online at susy.mdpi.com (William Wiskes). Please confirm which one is correct.
 Leonhard Blesius and Ellen Hines \orcidC{}}



\AuthorNames{William T. Wiskes, Leonhard Blesius and Ellen Hines}


\AuthorCitation{\hl{Wiskes,} %MDPI: Please carefully check the accuracy of names and affiliations.
 W.T.; Blesius, L.; Hines, E.}



\address[1]{%
Department of Geography and Environment, San Francisco State University, \hl{1600 Holloway Avenue,} %MDPI: We switched the address order, please confirm.
...
%%%
\begin{table}[H]
\caption{\hl{Confusion} %MDPI: We revised alignment and border line, please confirm.
...
%\begin{sidewaystable}
\begin{table}[H]
\caption{\hl{Formulas} %MDPI: We revised alignment and border line, please confirm.
...
\midrule
\text{Matthews Correlation Coefficient} & 0.9773 & TP\hl{*}TN %MDPI: Please check if * should be changed to multiplication sign (× $times$)
...
When looking at studies of similar areas, such as \hl{Sherba et al. (2014),} %Please cite reference with reference numbers, and place the numbers in square brackets [ ], for example [1], [1-3] or [1,3]， You may refer to the following the website: http://www.mdpi.com/authors/references.
...
\appendixstart
\appendix
\section[\appendixname~\thesection]{\hl{Complete Process Tree}} %MDPI: !!! Please cite Appendix A in the main text.


This is the complete process tree built in the eCognition extract of the road %Please check intended meaning has been retained.
\hl{network.} %MDPI: Please add figure caption for the two images below if possible, i.e., Figure A1. xxx.  Figure A2. xxx. 
...
Becker, B. \hl{(Affiliation}); %MDPI: please add his Affiliation
Maloney, S.  \hl{(Affiliation}). %MDPI: please add his Affiliation
\newblock Personal communication \hl{with leaders of Point Reyes National Seashore}, %%MDPI: please delete it
2020. 
...
\hl{Troendle,} %MDPI: We removed website link since it's not required in journal type, please confirm.
 C.A.; King, R.M.
...
\hl{Luce,} %MDPI: We removed website link since it's not required in journal type, please confirm.
 C.H.; Black, T.A.
...
Kelly, J.P.; Fox, K.J.
\newblock {\em Fish Species of Tomales Bay and Its Watershed}; The Tomales Bay Association: \hl{Point Reyes Station, CA, USA,} %MDPI: Newly added information. Please confirm. The following highlights without comment are the same
 1995.

\bibitem[Ketcham(2001)]{ketcham}
Ketcham, B.J.
\newblock {\em Point Reyes National Seashore Water Quality Monitoring Report, May
  1999--May 2001}; Point Reyes National Seashore: \hl{Point Reyes Station, CA, USA,} 2001.

\bibitem[Gronsdahl et~al.(2019)Gronsdahl, Moore, Rosenfeld, McCleary, and
  Winkler]{gronsdahl}
\hl{Gronsdahl,} %MDPI: We removed website link since it's not required in journal type, please confirm.
...
\hl{Dan~Moore,} %MDPI: We removed website link since it's not required in journal type, please confirm.
 R.; Wondzell, S.
...
\newblock {\em Remote Sensing and Image Interpretation}, 7th ed.;
  John Wiley \& Sons, Inc.: Hoboken, NJ, USA, 2015; pp. \hl{xii, 720.} %MDPI: Please provide the correct page number.
...
\newblock {\em USGS Lidar Science Strategy---Mapping the Technology to the Science:
  U.S. Geological Survey Open-File Report 2015}; \hl{US Department of the Interior, US Geological Survey: Washington, DC, USA,} 2016; Volume 1209, p. 33. https://doi.org/10.3133/ofr20151209.
...
\hl{National Research Council; Division on Earth and Life Studies; Ocean Studies Board; Committee on Best Practices for Shellfish Mariculture and the Effects of Commercial Activities in Drakes Estero, Pt. Reyes National Seashore, California.} %MDPI: We revised it to full name following google scholar, please confirm.
...
\hl{Quantum Spatial Inc.} %MDPI: We revised it to full name, please confirm.
\newblock {\em Marin County, California QL1 LiDAR: Technical Data Report}; \hl{Quantum Spatial Inc.:}
\newblock Corvallis, OR, USA, 2019.

\bibitem[ESRI(2020)]{esri}
ESRI.
\newblock ArcGIS Pro: Version 2.7. 2020. Available online: \url{https://support.esri.com/en/technical-article/000012500} \hl{(accessed on).} %MDPI: Please add the access date (format: Date Month Year), e.g., accessed on 1 January 2020.
...
\newblock {\em \hl{arXiv}} {\bf 2015}, \hl{arXiv:1503.00687.} %MDPI: We revised it following scholar, please confirm.
...
\newblock {\em Multispectral Image Analysis Using the Object-Oriented
  Paradigm}; CRC Press/Taylor \& Francis: Boca Raton, NJ, USA, 2007; \hl{pp. 24, 165.} %MDPI: Please check if page number is correct, if it should be page range 24--165.
...
Richards, J.A.J.A.
\newblock {\em Remote Sensing Digital Image Analysis: An Introduction}, 5th ed.; Springer:  \hl{Berlin/Heidelberg, Germany,} 
2013.
...
\hl{Reid,} %MDPI: We removed website link since it's not required in journal type, please confirm.
 L.M.; Dunne, T.
